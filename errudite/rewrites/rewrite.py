    ...
    def get_delta_performance(cls,
        ...
        for key in instance_keys:
            ...
            if key in instance_hash_rewritten and ori_key in instance_hash:
                ...
                p0 = instance_hash[ori_key].get_entry('prediction_PE', model)
                p1 = instance_hash_rewritten[key].get_entry('prediction_PE', model)
                p2 = instance_hash[ori_key].get_entry('prediction_KE', model)
                p3 = instance_hash_rewritten[key].get_entry('prediction_KE', model)
                p4 = instance_hash[ori_key].get_entry('prediction_LCE', model)
                p5 = instance_hash_rewritten[key].get_entry('prediction_LCE', model)
                if p0 and p1 and p2 and p3 and p4 and p5 and (p0.label != p1.label or p2.label != p3.label or p4.label != p5.label):
